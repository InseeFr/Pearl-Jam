const criteriaMessage = {
  ...
  dueDate: { fr: 'Echéance', en: 'Due date', sq: 'Ditët' },
  days: { fr: 'Jours', en: 'Days', sq: 'Data e duhur' },
  ...
  placeholderSearchHome: {
    fr: 'Nom, prénom, ville, enquête, ID, ID métier, téléphone...',
    en: 'Last name, first name, city, survey, ID, business ID, phone number...',
    sq: 'Mbiemri, emri, qyteti, sondazhi, ID, numri i telefonit...',
  },
};
