const addressMessage = {
  ...
  addressAdditionalAddress: { fr: `Complément d'adresse`, en: 'Additional address', sq: 'Adresë shtesë' },
  ...
  addressStreetName: { fr: 'Numéro et libellé de voie', en: 'Street number and name', sq: 'Numri dhe emri i rrugës' },
  ...
  addressCityPriorityDistrict: { fr: 'QPV', en: 'City Priority District', sq: 'Rajoni Prioritar i Qytetit' },
};
