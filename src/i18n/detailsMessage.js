const detailsMessage = {
  ...
  surveyUnitNoPhone: { fr: 'Pas de numéro de téléphone', en: 'No phone number', sq: 'Pa numër telefoni' },
  ...
  surveyUnitCommunications: { fr: 'Mes communications', en: 'My communications', sq: 'Komunikimet e mia' },
  surveyUnitDateOfBirth: { fr: 'Date de naissance', en: 'Date of birth', sq: 'Data e lindjes' },
  years: { fr: 'ans', en: 'years', sq: 'vjet' },
};
