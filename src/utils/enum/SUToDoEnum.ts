...
export const toDoEnum = {
  ...
  WEBSURVEY: { order: '4', value: D.toDoWebSurvey, stepName: D.toDoWebSurvey, color: '#F2994A80' },
  FINALIZE: { order: '5', value: D.toDoFinalize, stepName: D.stepFinalized, color: '#DFD3C3' },
