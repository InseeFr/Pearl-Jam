const buttonMessage = {
  ...
  addPhoneNumberButton: { fr: 'Ajouter un numéro', en: 'Add a phone number', sq: 'Shto një numër telefoni' },
  addContactAttemptButton: { fr: 'Ajouter un essai', en: 'Add a contact attempt', sq: 'Shto një përpjekje kontakti' },
  addContactOutcomeButton: { fr: 'Faire le bilan des contacts', en: 'Add contact outcome', sq: 'Shto rezultatin e kontakteve' },
  editContactOutcomeButton: { fr: 'Modifier le bilan des contacts', en: 'Edit contact outcome', sq: 'Ndrysho rezultatin e kontakteve' },
  ...
  markAllAsRead: { fr: 'Tout marquer comme lu', en: 'Mark all as read', sq: 'Shëno të gjitha si të lexuara' },
  ...
  noImNotSure: { fr: 'Non, je ne suis pas sûr(e)', en: 'No, I am not sure', sq: 'Jo, nuk jam i sigurt' },
