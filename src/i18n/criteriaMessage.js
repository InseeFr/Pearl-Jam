const criteriaMessage = {
  ...
  subSampleCluster: { fr: 'Sous-échantillon et grappe', en: 'Sub-sample and cluster', sq: 'Nën-mostër dhe grumbull' },
  ...
  placeholderSearchHome: {fr: 'Nom, prénom, ville, enquête, ID...', en: 'Last name, first name, city, survey, ID...', sq: 'Mbiemri, emri, qyteti, sondazhi, ID...'}
};
