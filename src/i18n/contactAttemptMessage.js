const contactAttemptMessage = {
  interviewAccepted: { fr: 'Enquête acceptée', en: 'Interview accepted', sq: 'Intervista u pranua' },
  ...
  permanentlyUnavailable: { fr: 'Indisponibilité définitive', en: 'Permanently unavailable', sq: 'Përgjithmonë e padisponueshme' },
  noticeOfPassageSent: { fr: "Dépôt d'un avis de passage", en: 'Notice of passage sent', sq: 'Njoftimi i kalimit u dërgua' },
  ...
  noContactAttempt: { fr: "Pas d'essais de contact", en: 'No contacts attempts', sq: 'Asnjë përpjekje për kontakt' },
  chooseAnOption: { fr: 'Choisissez une option', en: 'Choose an option', sq: 'Zgjidhni një opsion' },
  telephone: { fr: 'Téléphone', en: 'Telephone', sq: 'Telefoni' },
  datePicking: { fr: "Préciser la date de l'essai", en: 'Specify the date of the attempt', sq: 'Përcaktoni datën e përpjekjes' },
  contactAttemptDeletion: { fr: "Supprimer l'essai de contact", en: 'Delete contact attempt', sq: 'Fshi përpjekjen për kontakt' },
  at: { fr: 'à', en: 'at', sq: 'në' },
};
