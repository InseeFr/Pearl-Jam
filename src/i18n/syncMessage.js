const syncMessage = {
  ...
  syncResult: { fr: 'Résultat de la synchronisation', en: 'Result of synchronization', sq: 'Rezultati i sinkronizimit' },
  syncSuccess: { fr: 'La synchronisation a réussi.', en: 'Synchronization succeeded.', sq: 'Sinkronizimi u realizua me sukses.' },
  syncFailure: {
  ...
  synchronizationInProgress: { fr: 'Synchronisation en cours', en: 'Synchronization in progress', sq: 'Sinkronizimi në progres' },
  synchronizationWaiting: {
    fr: 'En attente de synchronisation',
    en: 'Waiting for synchronization.',
    sq: 'Duke pritur për sinkronizim.',
  },
  synchronizationEnding: { fr: 'Fin de la synchronisation', en: 'End of synchronization.', sq: 'Përfundimi i sinkronizimit' },
